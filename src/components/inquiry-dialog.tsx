  ...
  return (
    <Dialog open={open} onOpenChange={(v) => (v ? onOpenChange(v) : close())}>
      <DialogContent className="max-h-[92vh] overflow-y-auto sm:max-w-lg">
        <DialogHeader>
          <DialogTitle className="font-display text-2xl">Zapytaj o dostępność</DialogTitle>
          <DialogDescription>
            Właściciel ręcznie potwierdzi dostępność i skontaktuje się z Tobą.
          </DialogDescription>
        </DialogHeader>
        ...
        {status === "success" ? (
          <div className="flex flex-col items-center gap-3 py-8 text-center">
            ...
            <p className="font-display text-lg">Zapytanie wysłane</p>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-[1fr_120px]">
              ...
              <Field label="Liczba najemców" error={errors.tenants?.message}>
                <Input type="number" min={1} max={10} {...register("tenants")} />
              </Field>
            </div>
            <Field label="Wiadomość" error={errors.message?.message}>
              <Textarea rows={4} {...register("message")} placeholder="Opowiedz krótko o sobie i pobycie..." />
            </Field>
            ...
            <div className="flex justify-end gap-2 pt-2">
              ...
              <Button type="submit" disabled={status === "loading"} className="bg-accent text-accent-foreground hover:bg-accent/90">
